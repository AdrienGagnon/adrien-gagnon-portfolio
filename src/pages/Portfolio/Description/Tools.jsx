...
function Tools({ tools, githubLink }) {
    return (
        <div className={styles['tools-container']}>
            ...
            {githubLink && (
                <div className={styles.wrapper}>
                    <a className={styles['github-link']} href={githubLink}>
                        <svg
